...
| A web app that enables the user to enter a UPC code to see a list of the item's ingredients & whether or not they are vegan. Built using the Open Food Facts API. **JavaScript, HTML5, CSS3** | A trivia game in a web app built using the Open Trivia Database API. **JavaScript, HTML5, CSS3** | A web application that randomly generates a useless fun fact. Built using the Useless Facts API. **JavaScript, HTML5, CSS3** |
